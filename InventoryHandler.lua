--Credit to github.com/MoritzGoeckel for this script
...
function invHandler.checkInventory()
...
function invHandler.transferAllItemsToChest()
...
function invHandler.dropGargabe(item, keepN)
...
function invHandler.exchangeTool()
